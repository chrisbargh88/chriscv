  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Fallback repos so UI still shows something if rate-limited
        setRepos([
          {
            id: 1,
    ...
    <main className="portfolio-page">
      <div className="container-xl py-5">
        ...
        <header className="mb-4 text-center">
          <h1 className="neon-title mb-1">API Portfolio</h1>
        ...
        <div className="row g-4 mb-4">
          ...
          <div className="col-12 col-lg-6">
            <div className="card portfolio-card h-100 opensky-panel">
              <div className="card-body">
                <h2 className="panel-title mb-3">Sydney live flights (OpenSky)</h2>
                <LiveFlightsStat />
              </div>
            </div>
          </div>
          ...
          {/* BITRE delay card */}
          <div className="col-12 col-lg-6">
            <div className="card portfolio-card h-100 bitre-panel">
              <div className="card-body">
                <h2 className="panel-title mb-3">SYD domestic — average lateness (BITRE)</h2>
                <DelayChart />
              </div>
            </div>
          </div>
        ...
        <div className="card portfolio-card mb-5">
          <div className="card-body">
            <h2 className="panel-title mb-3">Live flight data (OpenSky)</h2>
            <LiveFlightsList />
          </div>
        </div>

        {/* Search + Filters */}
        <div className="portfolio-filter card border-0 mb-4">
          <div className="card-body">
            <form
        ...
        <div className="row g-4">
                ...
                <div className="card-body d-flex flex-column">
                  <h3 className="h6 fw-semibold mb-1">
                    <Link
                      ...
                      className="link-80s text-decoration-none"
                    >
                      {repo.name}
                    </Link>
                  </h3>
                  <p className="small muted-80s flex-grow-1 mb-3">
          ...
          {filtered.length === 0 && (
            <div className="col-12">
              <div className="alert alert-80s border-0">
                No matching projects — try resetting filters.
              </div>
            </div>
          )}
        </div>
